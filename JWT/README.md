...
This library is a modification of https://github.com/jwt-dotnet/jwt in which some classes have been modified to return optional values and take extra parameters. These parameters are delegate functions (Action<T>) which define what to do when an error occurs.

The original author of this library has NOT endorsed the modification (see: http://creativecommons.org/publicdomain/zero/1.0/ under "using or citing work").

The README below is just an outdated copy paste from the original library.
